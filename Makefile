...
OBJ = linalg.o main.o canvas.o perlin.o shapes.o renderer.o sphere.o plane.o cube.o cone.o cylinder.o triangle.o csg.o group.o bounding_box.o toroid.o Roots3and4.c obj_loader.c
